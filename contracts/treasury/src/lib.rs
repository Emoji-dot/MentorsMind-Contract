...
use shared::{
    require_not_paused, ReentrancyGuard, AdminTransfer, AdminChangeProposal,
    MIN_ADMIN_TIMELOCK_SECS, ADMIN_COOLING_OFF_SECS,
};
use soroban_sdk::{
...
pub enum Error {
    ...
    InvalidAdminChange = 11,
    SuspendedDuringAdminTransfer = 12,
}
